...
; ---------------------------------------------------------------------------
SHC_KosPlusDec:
	if SHC_KosPlus_LoopUnroll>0
		moveq	#(1<<SHC_KosPlus_LoopUnroll)-1,d7
	endif
...
.Code_01:
	...
	if SHC_KosPlus_LoopUnroll>0
		...
		and.w	d7,d6
		add.w	d6,d6
		lsr.w	#SHC_KosPlus_LoopUnroll,d4
