...
;			| Filename	| Folder
    ...
    if SMPS_S1DACSamples||SMPS_S2DACSamples
		if KCDrums=0
		incdac	Kick, "Sound/DAC/Sonic 1 & 2/OG/Kick.pcm"
		incdac	Snare, "Sound/DAC/Sonic 1 & 2/OG/Snare.pcm"
		incdac	Timpani, "Sound/DAC/Sonic 1 & 2/OG/Timpani.pcm"
		else
		incdac	Kick, "Sound/DAC/Sonic 1 & 2/KC/Kick.pcm"
		incdac	Snare, "Sound/DAC/Sonic 1 & 2/KC/Snare.pcm"
		incdac	Timpani, "Sound/DAC/Sonic 1 & 2/KC/Timpani.pcm"
		endif
    endif

    if SMPS_S2DACSamples
		if KCDrums=0
		incdac	Clap, "Sound/DAC/Sonic 1 & 2/OG/Clap.pcm"
		incdac	Scratch, "Sound/DAC/Sonic 1 & 2/OG/Scratch.pcm"
		incdac	Tom, "Sound/DAC/Sonic 1 & 2/OG/Tom.pcm"
		incdac	Bongo, "Sound/DAC/Sonic 1 & 2/OG/Bongo.pcm"
		else
		incdac	Clap, "Sound/DAC/Sonic 1 & 2/KC/Clap.pcm"
		incdac	Scratch, "Sound/DAC/Sonic 1 & 2/KC/Scratch.pcm"
		incdac	Tom, "Sound/DAC/Sonic 1 & 2/KC/Tom.pcm"
		incdac	Bongo, "Sound/DAC/Sonic 1 & 2/KC/Bongo.pcm"
		endif
    endif
    ...
    if SMPS_S3DACSamples||SMPS_SKDACSamples||SMPS_S3DDACSamples
		...
		incdac	CrashCymbalKC, "Sound/DAC/Sonic 3 & K & 3D/CrashCymbalKC.pcm"
