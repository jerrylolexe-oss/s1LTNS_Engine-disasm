...
ptr_dac81:	dcSample	TYPE_PCM, Kick, 11025					; $81	- Kick
	endif
	if KCDrums=0
ptr_dac82:	dcSample	TYPE_PCM, Snare, 23784					; $82	- Snare
	else
ptr_dac82:	dcSample	TYPE_PCM, Snare, 11025					; $82	- Snare
	endif
...
ptr_dac91:	dcSample	TYPE_PCM, Bongo, 9806					; $91	- Low-Bongo
	...
	if SMPS_S3DACSamples||SMPS_SKDACSamples||SMPS_S3DDACSamples
		; Sonic 3 & K & 3D
	if CleanS3DAC
ptr_dac92:	dcSample	TYPE_PCM, SnareS3, 13000				; $92	- Snare (S3)
	else
...
ptr_dac96:	dcSample	TYPE_PCM, TomS3, 6490					; $96	- Floor-Tom (S3)
	if CleanS3DAC
ptr_dac97:	dcSample	TYPE_PCM, KickS3, 13000					; $97	- Kick (S3)
	else
...
ptr_dac99:	dcSample	TYPE_PCM, CrashCymbal, 11025			; $99	- Crash Cymbal
	endif
