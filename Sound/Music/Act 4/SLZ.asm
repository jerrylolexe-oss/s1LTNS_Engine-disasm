Mus84_SLZ2_Header:
	...
	smpsHeaderVoice     Mus84_SLZ2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $06

	smpsHeaderDAC       Mus84_SLZ2_DAC
	smpsHeaderFM        Mus84_SLZ2_FM1,	$E8, $00
	smpsHeaderFM        Mus84_SLZ2_FM2,	$E8, $06
	smpsHeaderFM        Mus84_SLZ2_FM3,	$DC, $1A
	smpsHeaderFM        Mus84_SLZ2_FM4,	$DC, $1A
	smpsHeaderFM        Mus84_SLZ2_FM5,	$F4, $20
	smpsHeaderPSG       Mus84_SLZ2_PSG1,	$C4, $06, $00, sTone_05
	smpsHeaderPSG       Mus84_SLZ2_PSG2,	$C4, $06, $00, sTone_05
	smpsHeaderPSG       Mus84_SLZ2_PSG3,	$00, $04, $00, sTone_04
...
Mus84_SLZ2_Jump05:
	smpsCall            Mus84_SLZ2_Call00
	dc.b	nE6, $1E

Mus84_SLZ2_Loop00:
	dc.b	nE7, $06, nC7, $3C, nRst, $1E
	smpsLoop            $00, $03, Mus84_SLZ2_Loop00
	dc.b	nE7, $06, nC7, $18, nG5, $0C, nA5, nG6
	smpsJump            Mus84_SLZ2_Jump05

Mus84_SLZ2_Call00:
	smpsCall            Mus84_SLZ2_Call0A
...
Mus84_SLZ2_Loop01:
	...
	dc.b	nD4, $02, nRst, $01
	smpsAlterPitch      $FF
	smpsLoop            $00, $04, Mus84_SLZ2_Loop01
	smpsAlterPitch      $04
...
Mus84_SLZ2_Jump01:
	...
	smpsSetvoice        $03
	smpsAlterVol        $EC
	smpsCall            Mus84_SLZ2_Call01
	smpsAlterNote       $14
	dc.b	nA5, $01, smpsNoAttack
	smpsAlterNote       $00
	dc.b	nA5, $05
	smpsCall            Mus84_SLZ2_Call02
	dc.b	nEb4
	smpsAlterVol        $07
	dc.b	nEb4
	smpsSetvoice        $03
	...
	smpsModOff
	smpsAlterVol        $14
	smpsJump            Mus84_SLZ2_Jump01

Mus84_SLZ2_Call01:
	smpsCall            Mus84_SLZ2_Call09
	dc.b	nEb4
	smpsAlterVol        $07
	dc.b	nEb4
	smpsSetvoice        $03
