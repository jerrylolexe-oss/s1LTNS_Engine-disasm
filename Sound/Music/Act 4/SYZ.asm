Mus85_SYZ2_Header:
	...
	smpsHeaderVoice     Mus85_SYZ2_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $03

	smpsHeaderDAC       Mus85_SYZ2_DAC
	smpsHeaderFM        Mus85_SYZ2_FM1,	$F4, $11
	smpsHeaderFM        Mus85_SYZ2_FM2,	$E8, $0B
	smpsHeaderFM        Mus85_SYZ2_FM3,	$F4, $14
	smpsHeaderFM        Mus85_SYZ2_FM4,	$F4, $18
	smpsHeaderFM        Mus85_SYZ2_FM5,	$F4, $18
	smpsHeaderPSG       Mus85_SYZ2_PSG1,	$D0, $06, $00, sTone_06
	smpsHeaderPSG       Mus85_SYZ2_PSG2,	$E8, $07, $00, $00
	smpsHeaderPSG       Mus85_SYZ2_PSG3,	$00, $05, $00, sTone_04
...
Mus85_SYZ2_Jump02:
	...
	smpsModOff
	smpsAlterVol        $08
	smpsCall            Mus85_SYZ2_Call09
	smpsCall            Mus85_SYZ2_Call0A
...
Mus85_SYZ2_FM4:
	smpsPan             panLeft, $00
	smpsAlterNote       $03
	smpsCall            Mus85_SYZ2_Call01
	smpsAlterNote       $00

Mus85_SYZ2_Jump00:
	smpsModSet          $01, $01, $01, $04
	smpsSetvoice        $02
	smpsCall            Mus85_SYZ2_Call02
	smpsAlterVol        $FC
	dc.b	nD6, $02
	smpsCall            Mus85_SYZ2_Call03
	smpsAlterVol        $04
	smpsJump            Mus85_SYZ2_Jump00

Mus85_SYZ2_Call02:
	smpsCall            Mus85_SYZ2_Call0D
	dc.b	nA6, $30
	smpsCall            Mus85_SYZ2_Call0D
...
Mus85_SYZ2_Loop05:
	...
	smpsLoop            $00, $08, Mus85_SYZ2_Loop05
	smpsPSGAlterVol     $FF

Mus85_SYZ2_Jump03:
	dc.b	$02, nRst, nMaxPSG
	smpsJump            Mus85_SYZ2_Jump03

; DAC Data
Mus85_SYZ2_DAC:
	dc.b	dSnareS3, $06, $06, $06, $06, $06, $06, $04, $02, $04, dKickS3, $02

Mus85_SYZ2_Loop00:
	smpsCall            Mus85_SYZ2_Call00
	smpsLoop            $00, $03, Mus85_SYZ2_Loop00
	dc.b	nRst, $04, dKickS3, $08, dSnareS3, $06, dKickS3, dKickS3, $06, dSnareS3, dSnareS3, dSnareS3
	dc.b	$04, dKickS3, $02

Mus85_SYZ2_Loop01:
	smpsCall            Mus85_SYZ2_Call00
	smpsLoop            $00, $02, Mus85_SYZ2_Loop01
	dc.b	nRst, $04, dKickS3, $08, dSnareS3, $06, dKickS3, dKickS3, $0C, dSnareS3, dSnareS3, $06
	dc.b	$06, $06, $06, $10, $02, $04, dKickS3, $02

Mus85_SYZ2_Loop02:
	smpsCall            Mus85_SYZ2_Call00
	smpsLoop            $00, $03, Mus85_SYZ2_Loop02
	dc.b	nRst, $04, dKickS3, $08, dSnareS3, $06, dKickS3, dKickS3, $06, dSnareS3, dSnareS3, dSnareS3
	dc.b	$04, dKickS3, $02

Mus85_SYZ2_Loop03:
	smpsCall            Mus85_SYZ2_Call00
	smpsLoop            $00, $03, Mus85_SYZ2_Loop03
	dc.b	nRst, $0C, dSnareS3, $0A, dKickS3, $02, dSnareS3, $06, dSnareS3, dSnareS3, $06, $04
	dc.b	dKickS3, $02
	smpsJump            Mus85_SYZ2_Loop00

Mus85_SYZ2_Call00:
	dc.b	nRst, $04, dKickS3, $08, dSnareS3, $06, dKickS3, dKickS3, $0C, dSnareS3, $0A, dKickS3
	dc.b	$02
	smpsReturn
