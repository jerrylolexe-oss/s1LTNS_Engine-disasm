...
ptr_PeeloutTransition:	dc.w SonAni_PeeloutTransition-Ani_Sonic
...
SonAni_Run:	dc.b $FF,  fr_Run11,  fr_Run12,  fr_Run13,  fr_Run14,     afEnd,     afEnd, afEnd
		even
SonAni_PeeloutTransition:    dc.b $FF,  id_Walk,  afChange,  id_Run,  afChange,  id_Spindash,     afEnd,     afEnd, afEnd
        even
...
SonAni_Wait:	dc.b $17, fr_Stand, fr_Stand, fr_Stand, fr_Stand, fr_Stand, fr_Stand, fr_Stand, fr_Stand, fr_Stand
		dc.b fr_Stand, fr_Stand, fr_Stand, fr_Wait1, fr_Wait2, fr_Wait2, fr_Wait2, fr_Wait3, fr_Wait4, afBack, 2
		even
...
id_PeeloutTransition:    equ (ptr_PeeloutTransition-Ani_Sonic)/2    ; $21