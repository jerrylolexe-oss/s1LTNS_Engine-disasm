...
;			mappings		object				subtype	frame	VRAM setting
	...
	dbug	Map_Orb,		id_Orbinaut,		2,		0,		make_art_tile(ArtTile_SLZ_Orbinaut,1,0)				; SLZ Orbinaut
	; Level Objects
...
;	dbug	Map_Smash,		id_SmashWall,		0,		0,		make_art_tile(ArtTile_SLZ_Smashable_Wall,2,0)	; Smashable Wall
	dbug	Map_Fire,		id_LavaMaker,		0,		0,		make_art_tile(ArtTile_SLZ_Fireball,0,0)			; Fireball Spawner - spawns upward, add downward one, and sideward one	
...
;			mappings		object				subtype	frame	VRAM setting
	...
	standards
	; Badniks
	dbug	Map_Cat,		id_Caterkiller,		0,		0,		make_art_tile(ArtTile_SBZ_Caterkiller,1,0)				; Caterkiller badnik
