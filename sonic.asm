;  ==================================================
; | SONIC THE HEDGEHOG LETONICS' EDITION DISASSEMBLY |
;  ==================================================
; ===========================================================================
; Disassembly created by Letonics.
; Original disassembly by Hivebrain, Sonic Retro.
; https://github.com/sonicretro/s1disasm
; Clone Driver V2 made by Clownacy.
; Clone Driver port by TheBlad748.
; https://github.com/TheBlad768/s1disasm-clone-driver
; ===========================================================================
; WARNING!
; =========================================================================== 
...
; ===========================================================================
MB1: equ $A130F3 ;$080000-$0FFFFF
MB2: equ $A130F5 ;$100000-$17FFFF
MB3: equ $A130F7 ;$180000-$1FFFFF
MB4: equ $A130F9 ;$200000-$27FFFF
MB5: equ $A130FB ;$280000-$2FFFFF
MB6: equ $A130FD ;$300000-$37FFFF
MB7: equ $A130FF ;$380000-$3FFFFF
StartOfRom:
...
;		dc.l ErrorTrap
;	endif
		dc.b "SEGA SSF        " ; Hardware system ID (Console name)
...
Pal_GHZ1:			bincludePalette	"palette/GHZ Act 1.bin"
Pal_GHZ2:			bincludePalette	"palette/GHZ Act 2.bin"
Pal_GHZ3:			bincludePalette	"palette/GHZ Act 3.bin"
Pal_LZ1:			bincludePalette	"palette/LZ Act 1.bin"
Pal_LZ2:			bincludePalette	"palette/LZ Act 2.bin"
Pal_LZ3:			bincludePalette	"palette/LZ Act 3.bin"
Pal_SBZ3:			bincludePalette	"palette/SBZ Act 3.bin"
Pal_LZWater1:		bincludePalette	"palette/LZ Act 1 Underwater.bin"
Pal_LZWater2:		bincludePalette	"palette/LZ Act 2 Underwater.bin"
Pal_LZWater3:		bincludePalette	"palette/LZ Act 3 Underwater.bin"
Pal_SBZ3Water:		bincludePalette	"palette/SBZ Act 3 Underwater.bin"
Pal_MZ1:			bincludePalette	"palette/MZ Act 1.bin"
Pal_MZ2:			bincludePalette	"palette/MZ Act 2.bin"
Pal_MZ3:			bincludePalette	"palette/MZ Act 3.bin"
Pal_SLZ1:			bincludePalette	"palette/SLZ Act 1.bin"
Pal_SLZ2:			bincludePalette	"palette/SLZ Act 2.bin"
Pal_SLZ3:			bincludePalette	"palette/SLZ Act 3.bin"
Pal_SYZ1:			bincludePalette	"palette/SYZ Act 1.bin"
Pal_SYZ2:			bincludePalette	"palette/SYZ Act 2.bin"
Pal_SYZ3:			bincludePalette	"palette/SYZ Act 3.bin"
...
Pal_LZSonWater1:	bincludePalette	"palette/Sonic - LZ Act 1 Underwater.bin"
Pal_LZSonWater2:	bincludePalette	"palette/Sonic - LZ Act 2 Underwater.bin"
Pal_LZSonWater3:	bincludePalette	"palette/Sonic - LZ Act 3 Underwater.bin"
...
PlayLevel:
		...
		move.b	#$FF,(v_lives).w	; set lives to 3
		endif
		moveq	#0,d0
		move.w	d0,(v_rings).w	; clear rings
		move.l	d0,(v_time).w	; clear time
		...
		move.l	#6,(v_emldlist).w ; clear emeralds
		move.l	#6,(v_emldlist+4).w ; clear emeralds
		endif
...
Level_LoadPal:
		...
		moveq	#palid_LZSonWater1,d0 ; palette number $F (LZ)
...
Level_ChkWaterPal:
		...
		moveq	#palid_LZWater1,d0 ; palette $B (LZ underwater)
		add.b	(v_act).w,d0			; Adjust for act
...
;		zonewarning ColPointers,4
		dc.l Col_GHZ ; Pointer for Ending is missing by default and fixed by Letonics.
...
;        jsr   	Sonic_HomingAttack
		...
		beq.s	locret_13302			; if not, branch
        cmpi.b  #2,obAnim(a0) ; Is animation 2 active?
...
; ---------------------------------------------------------------------------
Blk16_GHZ:	binclude	"_maps/GHZ/GHZ.eni"
		even
		; LTNS: Try merging these two into on and then the tile one will be the GHZ1 one.
...
Nem_GHZ_2nd:	binclude	"artnem/8x8 - GHZ2.nem"	; GHZ secondary patterns
		even
Blk256_GHZ:	binclude	"_maps/GHZ/GHZ.kos"
		even
Blk16_LZ:	binclude	"_maps/LZ/LZ.eni"
		even
Nem_LZ:		binclude	"artnem/8x8 - LZ.nem"	; LZ primary patterns
		even
Blk256_LZ:	binclude	"_maps/LZ/LZ.kos"
		even
Blk16_MZ:	binclude	"_maps/MZ/MZ.eni"
		even
Nem_MZ:		binclude	"artnem/8x8 - MZ.nem"	; MZ primary patterns
		even
Blk256_MZ:	binclude	"_maps/MZ/MZ.kos"
		even
Blk16_SLZ:	binclude	"_maps/SLZ/SLZ.eni"
		even
Nem_SLZ:	binclude	"artnem/8x8 - SLZ.nem"	; SLZ primary patterns
		even
Blk256_SLZ:	binclude	"_maps/SLZ/SLZ.kos"
		even
Blk16_SYZ:	binclude	"_maps/SYZ/SYZ.eni"
		even
Nem_SYZ:	binclude	"artnem/8x8 - SYZ.nem"	; SYZ primary patterns
		even
Blk256_SYZ:	binclude	"_maps/SYZ/SYZ.kos"
		even
Blk16_SBZ:	binclude	"_maps/SBZ/SBZ.eni"
		even
Nem_SBZ:	binclude	"artnem/8x8 - SBZ.nem"	; SBZ primary patterns
		even
Blk256_SBZ:	binclude	"_maps/SBZ/SBZ.kos"
		even
; ---------------------------------------------------------------------------
...
Level_Index:
		...
		dc.w Level_LZ4-Level_Index, Level_LZbg-Level_Index, Level_NULL-Level_Index
		; MZ
		dc.w Level_MZ1-Level_Index, Level_MZ1bg-Level_Index, Level_MZ1-Level_Index
		dc.w Level_MZ2-Level_Index, Level_MZ2bg-Level_Index, Level_MZ2-Level_Index
		dc.w Level_MZ3-Level_Index, Level_MZ3bg-Level_Index, Level_MZ3-Level_Index
		dc.w Level_MZ4-Level_Index, Level_MZ1bg-Level_Index, Level_MZ4-Level_Index
		; SLZ
		dc.w Level_SLZ1-Level_Index, Level_SLZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_SLZ2-Level_Index, Level_SLZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_SLZ3-Level_Index, Level_SLZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_SLZ4-Level_Index, Level_SLZbg-Level_Index, Level_NULL-Level_Index
		; SYZ
		dc.w Level_SYZ1-Level_Index, Level_SYZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_SYZ2-Level_Index, Level_SYZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_SYZ3-Level_Index, Level_SYZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_SYZ4-Level_Index, Level_SYZbg-Level_Index, Level_NULL-Level_Index
		; SBZ
		...
		dc.w Level_SBZ3-Level_Index, Level_SBZ3bg-Level_Index, Level_SBZ3bg-Level_Index
		dc.w Level_SBZ4-Level_Index, Level_SBZ4bg-Level_Index, Level_SBZ4bg-Level_Index
;		zonewarning Level_Index,24
		; Ending
		dc.w Level_End-Level_Index, Level_GHZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_End-Level_Index, Level_GHZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_End-Level_Index, Level_GHZbg-Level_Index, Level_NULL-Level_Index
		dc.w Level_End-Level_Index, Level_GHZbg-Level_Index, Level_NULL-Level_Index

Level_GHZ1:		binclude	"levels/GHZ/ghz1.bin"
		even
Level_GHZ2:		binclude	"levels/GHZ/ghz2.bin"
		even
Level_GHZ3:		binclude	"levels/GHZ/ghz3.bin"
		even
Level_GHZ4:		binclude	"levels/GHZ/ghz4.bin"
		even
Level_GHZbg:	binclude	"levels/GHZ/ghzbg.bin"
		even
Level_LZ1:		binclude	"levels/LZ/lz1.bin"
		even
Level_LZ2:		binclude	"levels/LZ/lz2.bin"
		even
Level_LZ3:		binclude	"levels/LZ/lz3.bin"
		even
Level_LZ4:		binclude	"levels/LZ/lz4.bin"
		even
Level_LZbg:		binclude	"levels/LZ/lzbg.bin"
		even
Level_MZ1:		binclude	"levels/MZ/mz1.bin"
		even
Level_MZ1bg:	binclude	"levels/MZ/mz1bg.bin"
		even
Level_MZ2:		binclude	"levels/MZ/mz2.bin"
		even
Level_MZ2bg:	binclude	"levels/MZ/mz2bg.bin"
		even
Level_MZ3:		binclude	"levels/MZ/mz3.bin"
		even
Level_MZ3bg:	binclude	"levels/MZ/mz3bg.bin"
		even
Level_MZ4:		binclude	"levels/MZ/mz4.bin"
		even
Level_MZ4bg:	binclude	"levels/MZ/mz4bg.bin"
		even
Level_SLZ1:		binclude	"levels/SLZ/slz1.bin"
		even
Level_SLZ2:		binclude	"levels/SLZ/slz2.bin"
		even
Level_SLZ3:		binclude	"levels/SLZ/slz3.bin"
		even
Level_SLZ4:		binclude	"levels/SLZ/slz4.bin"
		even
Level_SLZbg:	binclude	"levels/SLZ/slzbg.bin"
		even
Level_SYZ1:		binclude	"levels/SYZ/syz1.bin"
		even
Level_SYZ2:		binclude	"levels/SYZ/syz2.bin"
		even
Level_SYZ3:		binclude	"levels/SYZ/syz3.bin"
		even
Level_SYZ4:		binclude	"levels/SYZ/syz4.bin"
		even
Level_SYZbg:	binclude	"levels/SYZ/syzbg.bin"
		even
Level_SBZ1:		binclude	"levels/SBZ/sbz1.bin"
		even
Level_SBZ1bg:	binclude	"levels/SBZ/sbz1bg.bin"
		even
Level_SBZ2:		binclude	"levels/SBZ/sbz2.bin"
		even
Level_SBZ2bg:	binclude	"levels/SBZ/sbz2bg.bin"
		even
Level_SBZ3:		binclude	"levels/SBZ/sbz3.bin"
		even
Level_SBZ3bg:	binclude	"levels/SBZ/sbz3bg.bin"
		even
Level_SBZ4:		binclude	"levels/SBZ/sbz4.bin"
		even
Level_SBZ4bg:	binclude	"levels/SBZ/sbz4bg.bin"
		even
Level_End:		binclude	"levels/GHZ/Ending/ending.bin"
		even
Level_NULL:		dc.b $FF, $FF, 0, 0, 0,	0
...
ObjPos_Index:
		...
		dc.w ObjPos_LZ4-ObjPos_Index, ObjPos_Null-ObjPos_Index
		; MZ
...
ObjPosSBZPlatform_Index:
		...
		dc.w ObjPos_SBZ1pf1-ObjPos_Index, ObjPos_SBZ1pf2-ObjPos_Index
		dc.b $FF, $FF, 0, 0, 0,	0
ObjPos_GHZ1:	binclude	"objpos/GHZ/ghz1.bin"
		even
ObjPos_GHZ2:	binclude	"objpos/GHZ/ghz2.bin"
		even
ObjPos_GHZ3:	binclude	"objpos/GHZ/ghz3.bin"
		even
ObjPos_GHZ4:	binclude	"objpos/GHZ/ghz4.bin"
		even
ObjPos_LZ1:		binclude	"objpos/LZ/lz1.bin"
		even
ObjPos_LZ2:		binclude	"objpos/LZ/lz2.bin"
		even
ObjPos_LZ3:		binclude	"objpos/LZ/lz3.bin"
		even
ObjPos_LZ4:		binclude	"objpos/LZ/lz4.bin"
		even
ObjPos_LZ1pf1:	binclude	"objpos/LZ/lz1pf1.bin"
		even
ObjPos_LZ1pf2:	binclude	"objpos/LZ/lz1pf2.bin"
		even
ObjPos_LZ2pf1:	binclude	"objpos/LZ/lz2pf1.bin"
		even
ObjPos_LZ2pf2:	binclude	"objpos/LZ/lz2pf2.bin"
		even
ObjPos_LZ3pf1:	binclude	"objpos/LZ/lz3pf1.bin"
		even
ObjPos_LZ3pf2:	binclude	"objpos/LZ/lz3pf2.bin"
		even
ObjPos_MZ1:		binclude	"objpos/MZ/mz1.bin"
		even
ObjPos_MZ2:		binclude	"objpos/MZ/mz2.bin"
		even
ObjPos_MZ3:		binclude	"objpos/MZ/mz3.bin"
		even
ObjPos_MZ4:		binclude	"objpos/MZ/mz4.bin"
		even
ObjPos_SLZ1:	binclude	"objpos/SLZ/slz1.bin"
		even
ObjPos_SLZ2:	binclude	"objpos/SLZ/slz2.bin"
		even
ObjPos_SLZ3:	binclude	"objpos/SLZ/slz3.bin"
		even
ObjPos_SLZ4:	binclude	"objpos/SLZ/slz4.bin"
		even
ObjPos_SYZ1:	binclude	"objpos/SYZ/syz1.bin"
		even
ObjPos_SYZ2:	binclude	"objpos/SYZ/syz2.bin"
		even
ObjPos_SYZ3:	binclude	"objpos/SYZ/syz3.bin"
		even
ObjPos_SYZ4:	binclude	"objpos/SYZ/syz4.bin"
		even
ObjPos_SBZ1:	binclude	"objpos/SBZ/sbz1.bin"
		even
ObjPos_SBZ2:	binclude	"objpos/SBZ/sbz2.bin"
		even
ObjPos_SBZ3:	binclude	"objpos/SBZ/sbz3.bin"
		even
ObjPos_SBZ4:	binclude	"objpos/SBZ/sbz4.bin"
		even
ObjPos_SBZ1pf1:	binclude	"objpos/SBZ/sbz1pf1.bin"
		even
ObjPos_SBZ1pf2:	binclude	"objpos/SBZ/sbz1pf2.bin"
		even
ObjPos_SBZ1pf3:	binclude	"objpos/SBZ/sbz1pf3.bin"
		even
ObjPos_SBZ1pf4:	binclude	"objpos/SBZ/sbz1pf4.bin"
		even
ObjPos_SBZ1pf5:	binclude	"objpos/SBZ/sbz1pf5.bin"
		even
ObjPos_SBZ1pf6:	binclude	"objpos/SBZ/sbz1pf6.bin"
		even
ObjPos_End:		binclude	"objpos/GHZ/Ending/ending.bin"
		even
